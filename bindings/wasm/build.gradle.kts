...
dependencies {
    ...
    api("com.whichlicense.identification:license:0.7.1-SNAPSHOT")
...
publishing {
    publications {
        create<MavenPublication>("wasm") {
            ...
            pom {
                name.set("WhichLicense libidentification/wasm")
                description.set("This library provides the TODO")
                url.set("https://github.com/whichlicense/libidentification/wasm")
                licenses {
                    license {
